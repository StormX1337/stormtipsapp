...
- **English throughout.** Interface, editorial content, legal documents, push
  notifications and email are one language, and the API serves it regardless of
  what the browser asks for — so nobody ever meets a half-translated page.
...
| [docs/localization.md](docs/localization.md)                 | Where the language lives, and adding one    |

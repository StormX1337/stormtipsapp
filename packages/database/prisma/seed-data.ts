...
export const SEED_MARKETS = [
  ...
  { key: 'double-chance', type: 'DOUBLE_CHANCE', name: 'Double chance', hasLine: false, sortOrder: 2 },
  ...
  { key: 'alt-totals', type: 'OVER_UNDER', name: 'Alternative goal line', hasLine: true, sortOrder: 5 },
  { key: 'team-totals', type: 'TEAM_TOTAL', name: 'Team total', hasLine: true, sortOrder: 6 },
  { key: 'asian-handicap', type: 'ASIAN_HANDICAP', name: 'Asian handicap', hasLine: true, sortOrder: 7 },
  { key: 'european-handicap', type: 'EUROPEAN_HANDICAP', name: 'European handicap', hasLine: true, sortOrder: 8 },
  { key: 'btts', type: 'BTTS', name: 'Both teams to score', hasLine: false, sortOrder: 9 },
  { key: 'ht-totals', type: 'HALF_OVER_UNDER', name: 'First half totals', hasLine: true, sortOrder: 10 },
  ...
  { key: 'correct-score', type: 'CORRECT_SCORE', name: 'Correct score', hasLine: false, sortOrder: 13 },
